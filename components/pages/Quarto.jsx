...
export default function Quarto({ room, onFinished }) {
  ...
  const posicoes = {
    11: { x: 250, y: 900, maxW: "200px", maxH: "100px" },
    12: { x: 1550, y: 600, maxW: "180px", maxH: "50px" },
    13: { x: 835, y: 800, maxW: "250px", maxH: "100px" },
    14: { x: 920, y: 0, maxW: "80px", maxH: "80px" },
    15: { x: 200, y: 500, maxW: "50px", maxH: "100px" },
  };
